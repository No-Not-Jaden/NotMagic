...
public class Items {
    ...
    public static ItemStack data(String s){
        if (s.equalsIgnoreCase("BasicWand")){
            ...
            item.addUnsafeEnchantment(Enchantment.DURABILITY, 1);
            return item;
        } else if (s.equalsIgnoreCase("SBSnipe")){
            ItemStack item = new ItemStack(Material.ENCHANTED_BOOK);
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Snipe Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Main Spell:");
            Lore.add(ChatColor.DARK_GREEN + "" + ChatColor.ITALIC + "Fires an arrow");
            Lore.add("");
            Meta.setLore(Lore);
            Meta.addItemFlags(ItemFlag.HIDE_ENCHANTS);
            item.setItemMeta(Meta);
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Burst Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Kinetic Electrocute");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Thunder Cloud Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Dark Summoning");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Dark Poisoning Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Locate Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Teleport Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Main Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Shield Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Dark Curse Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Shadow Wandering Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Absorb Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Freeze Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Iron Wall Attack Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Main Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Life Steal Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Main Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Smite Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Main Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Fireball Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Main Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Time Bomb Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Wither Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Drown Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Secondary Spell:");
            ...
            ItemMeta Meta = item.getItemMeta();
            assert Meta != null;
            Meta.setDisplayName(ChatColor.YELLOW + "Ice Shards Spell");
            ArrayList<String> Lore = new ArrayList<>();
            Lore.add("");
            Lore.add(ChatColor.GREEN + "" + ChatColor.ITALIC + "Main Spell:");
